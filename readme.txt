...
where the first two are implemented in asynchronous parallel fashion and the last one is single-threaded. Find our paper at https://arxiv.org/abs/1812.00885. Users should read the paper for algorithm descriptions. Parameters are defined in 

	util.h -> struct Params
One can either set parameter value in util.h or in makefile.
